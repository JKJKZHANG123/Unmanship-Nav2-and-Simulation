...
def generate_launch_description():
    ...
    laser_mapping_params = [
        ...
        {
            'use_sim_time': False,
            'use_imu_as_input': False,  # IMU is still enabled by mapping.imu_en; use the stable output-state model
            ...
            # The real boat body is the navigation base frame.
            'odom_header_frame_id': 'camera_init',
